...
//     try {
//       const response = await fetch(`${API_ENDPOINTS.REPORT}/filter-options`);
...
//     setLoading(true);
//     try {
//       let url = `${API_ENDPOINTS.REPORT}/reports`;
//       let options = {
//         method: 'GET',
//         headers: {
...
//       // If filters are provided, use POST method
//       if (filterData) {
//         url = `${API_ENDPOINTS.REPORT}/reports`;
//         options = {
//           method: 'POST',
//           headers: {
//             'Content-Type': 'application/json',
...
//       'Product Weight', 'Total Weight', 'Product Qty', 'Price Per Qty', 'Total Price', 'Status'
//     ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-blue-50 p-4 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{summaryStats.totalOrders}</p>
              </div>
            </div>
          </div>
          <div className="bg-green-50 p-4 rounded-lg">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">₹{summaryStats.totalAmount.toLocaleString('en-IN', {minimumFractionDigits: 2})}</p>
            </div>
          </div>
          <div className="bg-purple-50 p-4 rounded-lg">
            <div>
              <p className="text-sm text-gray-600">Total Quantity</p>
              <p className="text-2xl font-bold text-purple-600">{summaryStats.totalQuantity.toLocaleString()}</p>
            </div>
          </div>
          <div className="bg-orange-50 p-4 rounded-lg">
            <div>
              <p className="text-sm text-gray-600">Completed Orders</p>
              <p className="text-2xl font-bold text-orange-600">{summaryStats.statusBreakdown?.Completed || 0}</p>
            </div>
          </div>
        </div>
      )} */}
